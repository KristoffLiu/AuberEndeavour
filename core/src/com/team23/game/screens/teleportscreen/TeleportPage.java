...
public class TeleportPage extends UIPage {
    ...
    public TeleportPage(){
        ...
        textBlock.setRelativePosition(30,30, UIElement.HorizontalAlignment.leftAlignment, UIElement.VerticalAlignment.topAlignment);
        ...
        for(RectangleMapObject rectangleMapObject : rooms){
            ...
            button.setRelativePosition(
                    ...
                    UIElement.HorizontalAlignment.leftAlignment,
                    UIElement.VerticalAlignment.bottomAlignment);
